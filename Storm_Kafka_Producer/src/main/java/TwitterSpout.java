...
public class TwitterSpout extends BaseRichSpout {
    ...
    String _username;
    String _pwd;
    String consumer_key="COeKbS8MwC02DaUNgoh8twjCR";
    String consumer_secret="G0kvSFYfMEQ9krnHnP31jccdPRS3quS94wju5B3CjhGEOGmZSo";
    String access_token="796595630-EHolo0o8su2CIATVvo63MIrtHLi7njoNo5XDgSHp";
    String token_secret="urBbRVEa55IrcA3QWxNsArvFqCiVuHtE8UknE7qmK3bWUz";
